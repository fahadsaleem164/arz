...
export default function ContentSectionOne({data}){
      ...
      <Row className="justify-content-center">
        ...
        <Col xs="12" className="col-lg-7 col-md-6 col-xs-10">
          <Content.Box>
            ...
            <Content.Title as="h2" mb="30px" mbXL="50px">{displayData.title}</Content.Title>
        ...
        <Col xs="12" className="col-lg-4 offset-xl-1 col-md-6 col-xs-10">
            ...
            <Content.Text mb="40px" mbXL="60px">{displayData.description}</Content.Text>
            ...
            <img src={displayData.image2} />            </Content.ImageTwo>
